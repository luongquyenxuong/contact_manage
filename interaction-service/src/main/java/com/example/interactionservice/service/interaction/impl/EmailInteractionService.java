...
@Service("emailInteractionService")
public class EmailInteractionService extends InteractionServiceImpl {


    public EmailInteractionService(InteractionRepository interactionRepository, HelperService helperService) {
    ...
    public ResponseDTO<?> saveInteraction(UUID idContact) {
        ...
        if (responseEntity.getStatusCode().is2xxSuccessful() &&
            ...
            interaction.setInteractionType(InteractionType.EMAIL);
